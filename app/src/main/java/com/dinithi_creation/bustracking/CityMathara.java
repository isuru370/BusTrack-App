...
public class CityMathara extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_city_mathara, container, false);

        firestore = FirebaseFirestore.getInstance();
        startTimeId = view.findViewById(R.id.starttime);
        endTimeId = view.findViewById(R.id.endtime);
        start2 = view.findViewById(R.id.startcityid02);
        end = view.findViewById(R.id.endcityid);
        timeCreate = view.findViewById(R.id.timecreatebtn);
        skip = view.findViewById(R.id.skipbtn);
        timeA = view.findViewById(R.id.time1);
        timeB = view.findViewById(R.id.time2);
        timeC = view.findViewById(R.id.time3);
        timeD = view.findViewById(R.id.time4);
        timeE = view.findViewById(R.id.time5);
        timeF = view.findViewById(R.id.time6);
        timeG = view.findViewById(R.id.time7);
...
//                endTimeId.setText(format);
        ...
        timeCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(CityMathara.this.getContext(),Driver_Home_Activity.class));
    ...
    private void startTimeSelect() {
        TimePickerDialog timePickerDialog = new TimePickerDialog(CityMathara.this.getContext(),
